...
const connection = mongoose.connect(
    "mongodb+srv://Aruzuhed:Coder123@cluster0.1mvqycn.mongodb.net/?retryWrites=true&w=majority",
    {
...
app.use(session({
    store: MongoStore.create({
        mongoUrl: "mongodb+srv://Aruzuhed:Coder123@cluster0.1mvqycn.mongodb.net/?retryWrites=true&w=majority",
